    ...
    <div className="nav-megamenu course-megamenu" >
       ...
       <h5><FormattedMessage id="Popular" defaultMessage="Popular Courses"/></h5>
        ...
        <div className="Design">
         <p><FormattedMessage id="Design" defaultMessage="Grpahic Design"/></p> 
         <h3><FormattedMessage id="Make" defaultMessage="Design and Make Infograpghics"></FormattedMessage></h3>  
        </div>
